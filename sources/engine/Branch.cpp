...
Branch::Branch(Item* item, const IOConfig &config, const xmlpp::Element &root, bool checkFiles, Tree* parent): pItem(item), tTree(config, root,checkFiles,this), pParent(parent)
{
}
